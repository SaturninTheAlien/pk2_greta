...
RANDOM_MOVE_VERTIC._AND_HORIZ.*/
    ...
    AI_MOVE_X_SIN, //43
    AI_MOVE_Y_SIN, //44
    AI_MOVE_X_COS_NOPEA, //45
    AI_MOVE_Y_SIN_NOPEA, //46
    AI_MOVE_X_COS_HIDAS, //47
    AI_MOVE_Y_SIN_HIDAS, //48
    AI_MOVE_Y_SIN_VAPAA, //49
    ...
    AI_MOVE_DOWN_JOS_KYTKIN1_PAINETTU, //56
    AI_MOVE_UP_JOS_KYTKIN1_PAINETTU, //57
    AI_MOVE_LEFT_JOS_KYTKIN1_PAINETTU, //58
    AI_MOVE_RIGHT_JOS_KYTKIN1_PAINETTU, //59
    AI_MOVE_DOWN_JOS_KYTKIN2_PAINETTU, //60
    AI_MOVE_UP_JOS_KYTKIN2_PAINETTU, //61
    AI_MOVE_LEFT_JOS_KYTKIN2_PAINETTU, //62
    AI_MOVE_RIGHT_JOS_KYTKIN2_PAINETTU, //63
    AI_MOVE_DOWN_JOS_KYTKIN3_PAINETTU, //64
    AI_MOVE_UP_JOS_KYTKIN3_PAINETTU, //65
    AI_MOVE_LEFT_JOS_KYTKIN3_PAINETTU, //66
    AI_MOVE_RIGHT_JOS_KYTKIN3_PAINETTU, //67
