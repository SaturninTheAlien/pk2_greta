...
enum {
    ...
    AI_TRANSFORM_IF_PLAYER_NEARBY, //165
    AI_DIE_IF_PLAYER_NEARBY, //166
    AI_TRANSFORM_IF_PLAYER_AWAY, //167
    AI_DIE_IF_PLAYER_AWAY, //168
    ...
    AI_JUMP_ON_CLIFF, //181
    AI_JUMP_IN_FRONT_OF_WALL, //182
